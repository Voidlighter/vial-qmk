...
// #define RGB_DI_PIN B3 error said: longer a valid option and should be replaced with WS2812_DI_PIN or APA102_DI_PIN
#define WS2812_DI_PIN B3
#define DRIVER_LED_TOTAL 4 //一共有多少个灯，64+12个底灯
#define RGBLED_NUM 4 //DRIVER_LED_TOTAL
...
// #define RGBLIGHT_ANIMATIONS error said: no longer a valid option and should be removed
#endif
